...
export const projects: Project[] = [
  {
    id: "1",
    title: "Interactive Chatbot with LangGraph",
    description: "Live Chatbot application using LangGraph",
    longDescription: "Sophisticated interactive Chatbot system using LLM and LangGraph technology. Capable of search documents using RAG, query using SQL, and gather knowledge from web search. Also comes with a web demo with API intergration with backend.",
    technologies: ["Python", "LangGraph", "PostgreSQL", "Docker", "ReactJs", "NextJs"],
    category: "Natural Language Processing",
    image: "/images/chatbot.jpg",
    github: "https://github.com/chinhang0104/chatbot-web/",
    live: "https://chatbot-web-one-theta.vercel.app/",
    featured: true,
    status: "Completed",
    date: "2025",
  },
